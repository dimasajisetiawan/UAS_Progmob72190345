...
class NewsDetailPage extends StatelessWidget {
  Widget _headerNews(BuildContext context, News news) {
  ...
  Widget _body(BuildContext context, News news) {
    return CustomScrollView(
      slivers: <Widget>[
        SliverToBoxAdapter(
          child: _headerNews(context, news),
        ),
        SliverToBoxAdapter(
            child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(news.judul_berita, style: AppTheme.h1Style),
              SizedBox(
                height: 10,
              ),
              Row(
                children: <Widget>[
                  Text(news.nama_penulis ?? '', style: AppTheme.h6Style),
                  SizedBox(
                    width: 10,
                  ),
                  Text(news.tanggal_berita, style: AppTheme.h6Style),
                ],
              ),
              Divider(
                height: 20,
              ...
              Text(news.isi_berita ?? '', style: AppTheme.h4Style)
            ],
          ),
        ))
      ],
